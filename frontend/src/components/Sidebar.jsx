  ...
  return (
    ...
    <aside className="w-64 bg-slate-900 flex flex-col h-screen shadow-xl relative z-20 shrink-0">
      ...
      <div className="h-14 px-6 border-b border-slate-800 flex items-center bg-slate-950/30">
        <div className="flex items-center gap-2.5">
          ...
          <h1 className="text-xl font-bold tracking-tight text-white">
            GNN<span className="font-normal text-slate-400">Ticket</span>
          </h1>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto py-4 space-y-1">
        {navItem('dashboard', 'Panel de Control', 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6')}
        {navItem('tickets', 'Panel de Soporte', 'M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z')}
        {navItem('conocimiento', 'Base de Conocimiento', 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477-4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253')}
        {navItem('inventario', 'Inventario (Activos)', 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z')}
        {navItem('licencias', 'Licencias (Software)', 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z', ['Admin', 'Tecnico'])}
